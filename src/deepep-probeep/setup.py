...
if __name__ == '__main__':
    ...
    sources = ['csrc/deep_ep.cpp', 'csrc/moonep_binding.cpp',
               'csrc/moonep_expert_pool.cpp',
               'csrc/kernels/runtime.cu', 'csrc/kernels/layout.cu',
               'csrc/kernels/intranode.cu',
               'csrc/kernels/probeep_controller.cu',
               'csrc/kernels/probeep_histogram.cu',
               'csrc/kernels/probeep_plan.cu',
               'csrc/kernels/probeep_weight_transport.cu',
               'csrc/kernels/moonep_expert_io.cu',
               'csrc/kernels/moonep_transport.cu']
    include_dirs = ['csrc/']
    library_dirs = []
    nvcc_dlink = []
    extra_link_args = []
    ...
    if disable_nvshmem:
        ...
        sources.extend(['csrc/kernels/internode.cu', 'csrc/kernels/internode_ll.cu',
                        'csrc/kernels/moonep_exchange.cu'])
