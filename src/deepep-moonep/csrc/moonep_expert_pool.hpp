...
// first sixteen slots hold the rank's home experts and the following sixteen
// slots are the server-local replica workspace selected by the planner.
inline constexpr std::int64_t kExpertPoolHomeSlots = 16;
inline constexpr std::int64_t kExpertPoolReplicaSlots = 16;
...
static_assert(kExpertPoolWeightShardBytes == 939524096);
static_assert(kExpertPoolGradShardBytes == 1879048192);
static_assert(kExpertPoolBytes == 8455716864);
...
//   gate_weight [32, 7168, 2048]  BF16
//   up_weight   [32, 7168, 2048]  BF16
//   down_weight [32, 2048, 7168]  BF16
//   gate_grad   [32, 7168, 2048]  FP32
//   up_grad     [32, 7168, 2048]  FP32
//   down_grad   [32, 2048, 7168]  FP32
