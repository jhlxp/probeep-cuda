...
def main() -> None:
    ...
    try:
        for case_index, case in enumerate(cases):
            ...
            # This is the immutable case-level seed.  run_benchmark.py writes
            # PROBEEP_WEIGHT_VERSION for the active layer/phase/round; feeding
            # that derived value back as the next layer's base grows it by 1e9
            # per layer and eventually overflows the C++ int64 contract.
